...
const DEFAULT_GAME_SETTINGS: GameSettingType = {
  ...
  top_bonus: GAME_SETTINGS.DEFAULT_TOP_BONUS,
  penalty_for_no_win_1: GAME_SETTINGS.DEFAULT_PENALTY_FOR_NO_WIN_1,
  penalty_for_no_win_2: GAME_SETTINGS.DEFAULT_PENALTY_FOR_NO_WIN_2,
  penalty_for_no_win_3: GAME_SETTINGS.DEFAULT_PENALTY_FOR_NO_WIN_3,
  penalty_for_bust: GAME_SETTINGS.DEFAULT_PENALTY_FOR_BUST,
